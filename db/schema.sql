...
CREATE TABLE IF NOT EXISTS receipt_ocr_feedback_submissions (
  import_id TEXT PRIMARY KEY,
  user_id TEXT NOT NULL,
  project_id TEXT NOT NULL,
  transaction_id TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_receipt_ocr_feedback_submissions_user
...
CREATE TRIGGER IF NOT EXISTS trg_receipt_ocr_outcome_content_conflict
BEFORE INSERT ON receipt_ocr_field_outcomes
WHEN EXISTS (
  SELECT 1
...
CREATE TRIGGER IF NOT EXISTS trg_receipt_ocr_correction_content_conflict
BEFORE INSERT ON receipt_ocr_correction_events
WHEN EXISTS (
  SELECT 1
...
CREATE TRIGGER IF NOT EXISTS trg_receipt_ocr_feedback_submission_active_user
...
CREATE TRIGGER IF NOT EXISTS trg_receipt_ocr_feedback_submission_pending_conflict
BEFORE INSERT ON receipt_ocr_feedback_submissions
WHEN EXISTS (
  SELECT 1
...
CREATE TRIGGER IF NOT EXISTS trg_receipt_ocr_feedback_submission_content_conflict
BEFORE INSERT ON receipt_ocr_feedback_submissions
WHEN EXISTS (
  SELECT 1
